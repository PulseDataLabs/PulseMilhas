...
class MaxmilhasScraper(BaseScraper):
    ...
    title = "Maxmilhas"
    description = "Preço de venda de milhas no marketplace Maxmilhas."
    icon = "🛒"
    ...
    def fetch(self) -> pd.DataFrame:
        ...
        try:
            resp = session.get("https://www.maxmilhas.com.br/comprar-milhas", timeout=15)
            ...
            log.warning(f"Erro ao acessar Maxmilhas: {e}")
